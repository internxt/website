...
const InternxtForJournalists = ({ metatagsDescriptions, navbarLang, bannerLang, langJson, footerLang, lang }) => {
...
export async function getServerSideProps(ctx) {
  ...
  const langJson = require(`../assets/lang/en/internxt-for-journalists.json`);
...
export default InternxtForJournalists;
