        ...
        <Layout segmentName="legal" title={metatags.title} description={metatags[0].description} >
            ...
            <div className="flex flex-col items-center my-24">
                ...
                <div className="flex flex-col w-8/12 mb-16">
                    ...
                    <h5 className="font-avertabold text-4.5xl mb-6">
                    ...
                    <h5 className="font-avertabold text-4xl mb-6">
                        {description.privacy_policy_process_personal_data_title}
                    </h5>

                    <h5 className="font-avertabold text-3.5xl mb-6">
                    ...
                    <h5 className="font-avertabold text-2.5xl mb-6">
                ...
                <div className="flex flex-col w-8/12 mb-16">
                    ...
                    <ol>
                        <li className="font-avertalight mb-6">
