    ...
    <Layout segmentName="Legal" title={metatags.title} description={metatags[0].description} lang={lang}>
      ...
      <div className="flex flex-col items-center w-full py-20 pt-32 md:pt-64 px-6 xl:px-0 mx-auto max-w-5xl break-words">
        <div className="flex flex-col mb-16">
          <h1 className="text-4xl font-medium mb-8">{textContent.title}</h1>

          <p className="mb-6">{textContent.subtitle}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title2}</h2>

          <p className="mb-6">{textContent.subtitle2}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title3}</h2>

          <p className="mb-6">{textContent.subtitle3}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title4}</h2>

          <p className="mb-6">{textContent.subtitle4}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title5}</h2>

          <p className="mb-6">{textContent.subtitle5}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title6}</h2>

          <p className="mb-6">{textContent.subtitle6}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title7}</h2>

          <p className="mb-6">{textContent.subtitle7}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title8}</h2>

          <p className="mb-6">{textContent.subtitle8}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title9}</h2>

          <p className="mb-6">{textContent.subtitle9}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title10}</h2>
        ...
        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title11}</h2>

          <p className="mb-6">{textContent.subtitle11}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title12}</h2>
        ...
        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title13}</h2>

          <p className="mb-6">{textContent.subtitle13}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title14}</h2>
        ...
        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title15}</h2>

          <p className="mb-6">{textContent.subtitle15}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title16}</h2>
        ...
        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title17}</h2>

          <p className="mb-6">{textContent.subtitle17}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title18}</h2>

          <p className="mb-6">{textContent.subtitle18}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title19}</h2>

          <p className="mb-6">{textContent.subtitle19}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title20}</h2>

          <p className="mb-6">{textContent.subtitle20}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title21}</h2>
        ...
        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title22}</h2>

          <p className="mb-6">{textContent.subtitle22}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title23}</h2>
        ...
        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title24}</h2>
        ...
        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title25}</h2>

          <p className="mb-6">{textContent.subtitle25}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title26}</h2>

          <p className="mb-6">{textContent.subtitle26}</p>
        </div>

        <div className="flex flex-col mb-16 w-full">
          <h2 className="text-2xl font-medium mb-3">{textContent.title27}</h2>
          ...
          <h5 className="text-2xl font-medium mb-3">{textContent.privacy_policy_person_responsible_title}</h5>
          ...
          <h5 className=" text-4xl mb-6 mt-24">{textContent.privacy_policy_process_personal_data_title}</h5>
        ...
        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title28}</h2>

          <p className="mb-6">{textContent.subtitle28}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title29}</h2>
        ...
        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title30}</h2>

          <p className="mb-6">{textContent.subtitle30}</p>
        </div>

        <div className="flex flex-col mb-16">
          <h2 className="text-2xl font-medium mb-3">{textContent.title31}</h2>

          <p className="mb-6">{textContent.subtitle31}</p>
        </div>

        <div className="flex flex-col mb-16 w-full">
          <h2 className="text-2xl font-medium mb-3">{textContent.cookies_title}</h2>
          <h5 className="text-2xl mb-6">{textContent.cookies_subtitle1}</h5>

          <p className="mb-6">{textContent.cookies_data_part1}</p>

          <p className="mb-6">{textContent.cookies_data_part2}</p>

          <h5 className="text-2xl mb-6">{textContent.cookies_subtitle2}</h5>
          ...
          <h5 className="text-2xl mb-6">{textContent.cookies_subtitle3}</h5>
          ...
          <h5 className="text-2xl mb-6">{textContent.cookies_subtitle4}</h5>
        ...
        <div className="flex flex-col mb-6">
          <h2 className="text-2xl font-medium mb-3">{textContent.title33}</h2>
