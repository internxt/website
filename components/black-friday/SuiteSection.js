    ...
    <section className="overflow-hidden">
      <div className=" py-24 ">
        ...
        <div className="mt-32 flex-col space-y-12">
          <div className="center ml-56 flex flex-row pt-10">
            ...
            <div className="ml-auto flex h-80 w-2/5 rounded-l-3xl bg-black"></div>
          </div>
          <div className="center mr-56 flex flex-row space-y-5 pt-10">
            <div className="mr-auto flex h-80 w-2/5 rounded-r-3xl bg-black"></div>
            <div className="flex flex-col justify-center">
          ...
          <div className="center space ml-56 flex flex-row pt-10">
            <div className="flex flex-col justify-center">
