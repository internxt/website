    ...
    <section className="overflow-hidden">
      <div className="flex flex-col items-center bg-black bg-opacity-5 pt-20 md:p-20">
        <div className="flex flex-col items-center space-y-10">
          ...
          <p className="text-center md:w-full md:max-w-2xl">{textContent.subTitle}</p>
          <p className="text-center text-3xl font-semibold md:w-full md:max-w-xl">{textContent.panel.title}</p>
          <div className="grid w-full grid-cols-1 justify-items-center gap-x-10 gap-y-20 md:grid-cols-2 lg:grid-cols-4 lg:gap-x-10 xl:gap-x-20">
