  ...
  return (
    ...
    >
      <div className="flex flex-col items-center py-16">
        ...
        <RevealY className="flex h-full w-full max-w-[760px] flex-col pt-6">
          <img
        ...
        <div className="absolute left-0 top-20 flex -translate-x-24">
          <Image
        ...
        <div className="absolute right-0 top-32 flex translate-x-12">
          <Image
