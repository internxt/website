...
const FeatureSection = ({
  ...
  <section>
    ...
    <div className="flex flex-col items-center my-10 md:my-20 mb-32">
      ...
      <div className="flex flex-col items-center text-center mb-24 font-semibold px-6 text-gray-20">
      ...
      <div className="grid grid-flow-row grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-20 md:gap-24">
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <img className="h-12 select-none" loading="lazy" src="../../images/lifetime/icons-dark/privacy-icon.png" alt="Eye slash" draggable="false" />

          <div className="flex flex-col items-center text-center space-y-3">

            <span className="font-semibold text-xl text-gray-20">
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <img className="h-12 select-none" loading="lazy" src="../../images/lifetime/icons-dark/unlimited-icon.png" alt="Infinity" draggable="false" />
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <img className="h-12 select-none" loading="lazy" src="../../images/lifetime/icons-dark/improvement-icon.png" alt="Person group" draggable="false" />
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <img className="h-12 select-none" loading="lazy" src="../../images/lifetime/icons-dark/security-icon.png" alt="Lock" draggable="false" />
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <img className="h-12 select-none" loading="lazy" src="../../images/lifetime/icons-dark/new-icon.png" alt="List numbers" draggable="false" />
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <img className="h-12 select-none" loading="lazy" src="../../images/lifetime/icons-dark/support-icon.png" alt="Person group signal" draggable="false" />
