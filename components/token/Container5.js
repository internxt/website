        ...
        <div className={background} id='coinbase'>
            <div className={`${styles.container} sm:items-center sm:flex-col sm:py-16 lg:pt-8 lg:justify-center xl:justify-center`}>
                <div className={`${styles.main} sm:w-full sm:items-center lg:pt-32`}>
                    ...
                    <p data-aos="fade-up" data-aos-duration="300" className={`${styles.subtitle} sm:text-xl sm:text-center sm:w-84 lg:text-xl lg:w-100`}>
                        {description[0].subtitle}
                    </p>

                    <p data-aos="fade-up" data-aos-duration="300" className={`${styles.subtitle} sm:text-xl sm:text-center sm:w-84 lg:text-xl lg:w-102`}>
                        {description[0].subtitle2}
                    </p>

                    <div data-aos="fade-up" data-aos-duration="300" className={`${styles.button_container} lg:mt-16`}>
