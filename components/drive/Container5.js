        ...
        <div className={background}>
            <div className={styles.container}>
                <div className={`${styles.main} items-center`}>
                    <h1 data-aos="fade-up" data-aos-duration="300" className={`${styles.title1} leading-10 sm:text-4xl sm:text-center sm:mt-12 sm:w-80 lg:text-5xl xl:mt-24`}>
                        {description[0].title}
                    </h1>

                    <p data-aos="fade-up" data-aos-duration="300" className={`${styles.subtitle1} sm:text-xl sm:text-center sm:w-80 lg:text-lg lg:w-10/12 lg:pt-2 xl:text-center`}>
            ...
            <div className={`${styles.container2} max-w-1600 sm:py-12 sm:justify-center sm:flex-col-reverse lg:py-16`}>
                <div data-aos="fade-up" data-aos-duration="300" className={`${styles.hand} sm:w-11/12 lg:w-104`}>
                ...
                <div className={`${styles.main} sm:items-center lg:pl-32`}>
                    <h1 data-aos="fade-up" data-aos-duration="300" data-aos-delay="100" className={`${styles.title2} leading-10 sm:text-4xl sm:text-center sm:w-80 lg:text-5xl lg:w-84 lg:leading-tight xl:leading-13 xl:mb-2`}>
                        {description[0].title2}
                    </h1>

                    <p data-aos="fade-up" data-aos-duration="300" data-aos-delay="100" className={`${styles.subtitle2} sm:text-xl sm:text-center sm:w-80 lg:text-lg lg:w-96`}>
                    ...
                    <div className={`${styles.links} sm:justify-evenly sm:w-80`}>
                        ...
                        <a data-aos="fade-up" data-aos-duration="300" data-aos-delay="50" href={downloadUrl} target="_blank" className={`${styles.link} hover:opacity-80 flex flex-row w-auto items-center sm:p-0 lg:text-lg lg:mb-16`}>
