      ...
      <div className="content px-6 pb-24 flex flex-col">
        <div className={`flex flex-col items-center justify-center w-full text-center flex-shrink-0 py-20 md:py-24`}>
            ...
            <a href={`${lang ? (lang === "en" ? "" : lang) : ""}/products`} className="text-lg font-semibold sm:font-normal text-blue-60">
              <div className="flex flex-row items-center">{textContent.cta}<img className="mt-0.5 ml-2" src="/icons/chevronBold.svg" draggable="false"/></div>
            </a>
        </div>
          ...
          <div className={`col-span-2 ${styles.featureBox} grid grid-cols-1 grid-rows-2 sm:grid-cols-2 sm:grid-rows-1 gap-0 auto-cols-min bg-white rounded-3xl overflow-hidden`}>
            <div className={`sm:row-auto flex flex-col flex-shrink-0 pb-0 p-12 sm:pb-12 lg:p-16 space-y-6`}>
              ...
              <a href="https://help.internxt.com/en/articles/5387164-what-is-zero-knowledge-encryption" target="_blank" className="text-lg text-blue-60">
                <div className="flex flex-row items-center">{textContent.feature1.cta}<img className="mt-0.5 ml-2" src="/icons/chevron.svg" draggable="false"/></div>
              </a>
            </div>
          ...
          <div className={`col-span-2 sm:col-span-1 z-10 ${styles.featureBox} flex flex-col md:flex-1 justify-self-start p-12 px-8 lg:p-16 lg:py-14 bg-white rounded-3xl overflow-hidden space-y-8`}>
            ...
            <div className="flex flex-col text-left space-y-6">
              ...
              <a href={`${lang ? (lang === "en" ? "" : lang) : ""}/products`} className="text-lg text-blue-60">
                <div className="flex flex-row items-center">{textContent.feature2.cta}<img className="mt-0.5 ml-2" src="/icons/chevron.svg" draggable="false"/></div>
              </a>
            </div>
          </div>
          ...
          <div className={`col-span-2 sm:col-span-1 z-10 ${styles.featureBox} flex flex-col justify-self-start md:flex-1 p-12 px-8 lg:p-16 lg:py-14 bg-white rounded-3xl overflow-hidden space-y-8`}>
            ...
            <div className="flex flex-col text-left space-y-6">
              ...
              <a href="/" target="_blank" className="text-lg text-blue-60">
                <div className="flex flex-row items-center">{textContent.feature3.cta}<img className="mt-0.5 ml-2" src="/icons/chevron.svg" draggable="false"/></div>
              </a>
            </div>
          </div>
