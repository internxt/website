        ...
        <div className={background}>
            <div className={`${styles.container} sm:items-center sm:justify-center sm:flex-col`}>
                <div className={`${styles.main} sm:items-center sm:w-auto sm:p-0`}>
                    <h1 data-aos="fade-up" data-aos-duration="300" data-aos-delay="100" className={`${styles.title} leading-10 sm:text-4xl sm:text-center sm:w-80 sm:mt-16 lg:text-5xl lg:w-104 lg:leading-tight xl:leading-13`}>
                        {description[0].title}
                    </h1>

                    <p data-aos="fade-up" data-aos-duration="300" data-aos-delay="100" className={`${styles.subtitle} sm:text-xl sm:text-center sm:w-80 sm:mb-12 sm:pt-4 lg:text-lg lg:w-96`}>
                ...
                <div data-aos="fade-up" data-aos-duration="300" className={`${styles.image} sm:hidden`}>
                    <Image src="/images/1440/Drive/Section 6/Business.png" width={740} height={704} />
                </div>

                <div data-aos="fade-up" data-aos-duration="300" className={`hidden sm:block sm:mt-12`}>
