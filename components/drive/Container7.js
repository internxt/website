    ...
    return (
        <div className={background}>
            <div className={`${styles.cards_container} sm:items-center sm:flex-col sm:mb-24 xl:my-12`}>
                <div data-aos="fade-up" data-aos-duration="300" className="flex justify-center"><InfoCard title={title} subtitle={subtitle} subtitle2={subtitle2} linkText={description[0].link1} link={LINK_INFOCARD_1} image="Deloitte" width={137} heigth={27} /></div>
                <div className="hidden sm:block sm:h-1 sm:w-10/12 sm:bg-gray-300 sm:mt-12 sm:mb-6"></div>
                <div data-aos="fade-up" data-aos-duration="300" data-aos-delay="150" className="flex justify-center"><InfoCard title={title2} subtitle={subtitle3} subtitle2={subtitle4} linkText={description[0].link2} link={LINK_INFOCARD_2} linkText2={description[0].link3} link2={LINK2_INFOCARD_2} image="IEEE" width={130} heigth={38} /></div>
            </div>
        </div>
     );
}
