      ...
      <div className={`${styles.container} sm:flex-col max-w-1600 xl:items-center xl:justify-center`}>
        <div className={`${styles.main} sm:w-full sm:items-center sm:p-0 lg:pl-24`}>
          <h1
            ...
            className={`${styles.title} leading-10 sm:text-4xl sm:text-center sm:mt-12 sm:w-80 lg:text-5xl lg:w-112 lg:leading-12 xl:leading-13`}
          >
            {description[0].title}
          </h1>
          ...
          <p
            data-aos="fade-up"
            data-aos-duration="300"
            className={`${styles.subtitle} sm:text-xl sm:text-center sm:w-80 sm:pt-4 lg:text-lg lg:w-84`}
          >
          ...
          <p
            data-aos="fade-up"
            data-aos-duration="300"
            className={`${styles.subtitle} sm:text-xl sm:text-center sm:w-80 lg:text-lg lg:w-84`}
          >
