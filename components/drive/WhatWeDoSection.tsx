...
const WhatWeDoSection = ({
  ...
  const Cards = [
    {
      icon: Password,
      title: textContent.section7.card1.title,
      description: textContent.section7.card1.subtitle,
    },
    {
      icon: Key,
      title: textContent.section7.card2.title,
      description: textContent.section7.card2.subtitle,
    },
    {
      icon: ShieldCheck,
      title: textContent.section7.card3.title,
      description: textContent.section7.card3.subtitle,
    },
    {
      icon: LockKey,
      title: textContent.section7.card4.title,
      description: textContent.section7.card4.subtitle,
    },
  ];
