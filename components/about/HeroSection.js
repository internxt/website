      ...
      <div className="relative flex-col max-h-screen md:overflow-hidden">
        <div className="relative pt-24 md:pt-6">
          <div className="absolute top-0 flex-col justify-end w-full h-full max-h-screen">
            <div class="absolute bottom-0 flex h-1/3 md:h-1/2 xl:h-2/5 w-full bg-gradient-to-t from-black to-transparent transition-all duration-150 ease-in-out"></div>
        ...
        <div className="absolute bottom-0 flex flex-col justify-end w-full h-full text-left sm:text-center -mb-64 md:-mb-12 lg:mb-0 px-8 pb-8 transition-all duration-150 ease-in-out">
          ...
          <p className="mb-12 lg:text-lg text-neutral-40 md:text-white">{textContent.description.line1}<br className="hidden sm:inline-flex"/> {textContent.description.line2}<br className="hidden sm:inline-flex"/> {textContent.description.line3}</p>
        </div>
      </div>
    </div>
  );
