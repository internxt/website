  ...
  return (
    <div className="relative w-full sm:w-56 bg-neutral-20 rounded-2xl shadow-lg overflow-hidden select-none">
      ...
      <div className="absolute h-full w-full flex flex-col justify-end p-8 sm:p-6">
        <a href={`https://es.linkedin.com/in/${info.linkedin}`} target="_blank" className="w-10 h-10 sm:w-6 sm:h-6 mb-4 sm:mb-2"><img loading="lazy" className="w-10 h-10 sm:w-6 sm:h-6" src={`../../icons/social/white/linkedin.svg`} draggable="false"/></a>
