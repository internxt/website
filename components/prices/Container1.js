    ...
    return ( 
        <div className={styles.main_container}>
            ...
            <div className={`${styles.first_half} `}>
                <h1 data-aos="fade-up"
                    data-aos-delay="150"
                    data-aos-duration="500" className={`${styles.title} leading-9 sm:text-4xl sm:w-80 lg:text-4.5xl`}>
                    {
                ...
                <p data-aos="fade-up"
                    data-aos-delay="350"
                    data-aos-duration="500" className={`${styles.subtitle} sm:text-xl sm:w-80 lg:text-lg xl:mt-4`}>
                    {description[0].subtitle}
                </p>

                <p data-aos="fade-up"
                    data-aos-delay="450"
                    data-aos-duration="500" className={`${styles.subtitle} sm:text-xl sm:w-80 lg:text-lg`}>
                    {description[0].subtitle2}
                </p>

                <div data-aos="fade-up"
                    data-aos-delay="650"
                    data-aos-duration="500" className={`${styles.switch_container} sm:mt-12 sm:w-auto sm:h-12 sm:px-2 lg:h-12 lg:w-72 lg:mt-16`}>
            ...
            
            {
                individual ?
                    <div data-aos="fade-up"
                        data-aos-delay="850"
                        data-aos-duration="500" className={`grid grid-cols-4 gap-3 sm:grid-cols-1 sm:gap-y-8`}>
                        <div data-aos="fade-up" data-aos-duration="300">
                            <PriceCard free="true" size={10} individual={true} descriptions={cardDescriptions} />
                        </div>
