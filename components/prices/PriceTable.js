  ...
  return (
    <section className="bg-neutral-10">
      ...
      <div className="flex flex-col items-center">
        ...
        <button className="mt-4 mb-10 text-center text-blue-60 active:text-blue-50 font-semibold cursor-pointer" onClick={() => { setIndividual(!individual); if (billingFrequency === -1) { setTimeout(() => { setBillingFrequency(12); }, 50); } }}>
