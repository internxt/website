        ...
        <div className="flex flex-row p-0.5 text-sm bg-neutral-20 rounded-lg">
          ...
          >
            <div className={`${billingFrequency !== -1 ? 'flex' : 'hidden'} content flex-row flex-wrap justify-center justify-items-center items-end p-6 py-14 pb-20`}>
              ...
              <PriceCard planType="individual" storage={pricings.individuals.GB20.storage} price={billingPrice(pricings.individuals.GB20.price)} billingFrequency={billingFrequency} cta={['checkout',`${pricings.individuals.GB20.stripeID}`]} popular={pricings.individuals.GB20.popular} lang={props.lang} />
              <PriceCard planType="individual" storage={pricings.individuals.GB200.storage} price={billingPrice(pricings.individuals.GB200.price)} billingFrequency={billingFrequency} cta={['checkout',`${pricings.individuals.GB200.stripeID}`]} popular={pricings.individuals.GB200.popular} lang={props.lang} />
              <PriceCard planType="individual" storage={pricings.individuals.TB2.storage} price={billingPrice(pricings.individuals.TB2.price)} billingFrequency={billingFrequency} cta={['checkout',`${pricings.individuals.TB2.stripeID}`]} popular={pricings.individuals.TB2.popular} lang={props.lang} />
            </div>
            <div className={`${billingFrequency === -1 ? 'flex' : 'hidden'} content flex-row flex-wrap justify-center justify-items-center items-end p-6 py-14 pb-20`}>
