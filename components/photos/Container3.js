        ...
        <div className={background}>
            <div className={`${styles.container} max-w-1600 sm:flex-col sm:items-center`}>
                <div className={`${styles.main} sm:items-center sm:p-0 lg:pl-32 lg:py-16`}>
                    <h1 data-aos="fade-up" data-aos-duration="300" data-aos-delay="100" className={`${styles.title} leading-10 sm:text-4xl sm:text-center sm:w-84 sm:mt-16 lg:text-5xl lg:max-w-none lg:w-104 xl:leading-14`}>
                        {description[0].title}
                    </h1>

                    <p data-aos="fade-up" data-aos-duration="300" data-aos-delay="100" className={`${styles.subtitle} sm:text-xl sm:text-center sm:w-80 lg:text-xl lg:w-100`}>
