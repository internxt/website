    ...
    return ( 
        <div className={background}>
            <div className={`${styles.main_container} sm:py-16 lg:pb-16`}>
                <h1 data-aos="fade-up" data-aos-duration="300" className={`${styles.title} leading-9 sm:text-4xl sm:w-80 lg:text-5xl xl:leading-12`}>
                    {description[0].title}
                </h1>

                <p data-aos="fade-up" data-aos-duration="300" className={`${styles.subtitle} sm:text-xl sm:w-80 lg:text-xl lg:w-7/12`}>
                    {description[0].subtitle}
                </p>

                <div className="grid grid-cols-4 gap-x-4 sm:grid-cols-1 sm:gap-y-8 sm:my-16 lg:pb-12 lg:mt-12 xl:mt-16">
                    <div data-aos="fade-up" data-aos-duration="300"><PriceCard free="true" size={10} individual={true} descriptions={cardDescriptions} /></div>
                ...
                <Link href="/pricing">
                    <a data-aos="fade-up" data-aos-duration="300" 
