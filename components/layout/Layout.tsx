...
LayoutProps) {
  ...
  const showBanner = !excludedURL.includes(router.pathname); //This is for the banner to be shown in all pages except the ones in the array (pricing and black friday)
