  ...
  return (
    <section className={`flex flex-col w-full ${darkMode ? 'bg-cool-gray-100 text-white' : 'bg-cool-gray-5'}`}>
      <div className="flex flex-col items-center justify-center w-full px-6 py-16 sm:p-20">
        ...
        {/* Supporters from EU and Camara de comercio de España */}
        <div className="hidden flex-col space-y-6 sm:space-x-20 py-12 justify-center mx-6 md:mx-10 lg:mx-32 bg-white border border-cool-gray-10 rounded-2xl mb-16">
        ...
        <div className={`${hideNewsletter ? 'hidden' : 'flex'} w-full flex-col md:flex-row space-y-6 md:space-x-20 md:space-y-0 justify-center items-center mb-16`}>
          ...
          >
            ...
            <input
              ...
              className="flex justify-center w-full sm:w-auto items-center px-4 py-2 border border-transparent rounded-lg text-base font-medium text-white bg-blue-60 active:bg-blue-70 focus:outline-none transition-all duration-75 cursor-pointer"
            />
          </form>
                ...
                <div>
                  ...
                  >
                    <Disclosure.Panel className={`flex flex-col ${darkMode ? 'text-cool-gray-30' : 'text-cool-gray-60'} p-4 pt-2 space-y-4`}>
                      ...
                      <Link href="" locale={lang}>
                        <a className="flex flex-row items-center text-cool-gray-60">
                          <div>
                            {textContent.FooterSection.sections.products.send}
                          </div>
