                ...
                <tr className="relative z-10 bg-white bg-opacity-80 backdrop-filter backdrop-blur-md">
                  ...
                  <th className="relative p-16 text-lg font-medium">
                    ...
                    <div className="absolute bottom-0 left-0 flex flex-col items-center justify-center w-32 h-32 bg-blue-10 rounded-t-2xl space-y-1.5">
                      <img loading="lazy" className="object-cover object-center w-12 h-12" src={`/images/comparison/competitors/${competitors[0].logo}.webp`} draggable="false" alt={`${competitors[0].name} logo`} />
                  ...
                  {competitors.slice(1).map((col, index) => (
                    <th className="relative p-14 font-normal" key={col.name}>
                      {' '}
                      <div className={`absolute bottom-0 left-0 flex flex-col items-center justify-center w-28 h-28 rounded-t-lg space-y-1 ${index % 2 !== 0 && 'bg-cool-gray-5'}`}>
                        <img loading="lazy" className="object-cover object-center w-8 h-8" src={`/images/comparison/competitors/${col.logo}.webp`} draggable="false" alt={`${col.name} logo`} />
                        <span>{col.name}</span>
                      </div>
                    </th>
                  ))}
                      ...
                      <tr className="h-14 md:h-12" key={row.title}>
                        ...
                        {row.feature.slice(1).map((feature, columnIndex) => (
                          <td className={`${columnIndex % 2 !== 0 && 'bg-cool-gray-5'}`} key={`${row.title}${columnIndex.toString()}`}>
                            <div className="flex flex-col items-center justify-center h-full">
                              {typeof feature === 'boolean' && (feature ? <UilCheck className="w-6 h-6 text-cool-gray-40" /> : <UilMinus className="w-6 h-6 text-cool-gray-20" />)}
