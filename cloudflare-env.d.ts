/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 7b23de6b36dc8758b802642a7975e4c0)
...
interface __BaseEnv_CloudflareEnv {
	...
	SHEET_LIMITER: RateLimit;
	TEMP_MAIL_CREATE_LIMITER: RateLimit;
	TEMP_MAIL_INBOX_LIMITER: RateLimit;
	TEMP_MAIL_MESSAGE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
}
