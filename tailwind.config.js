...
module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      NeueEinstellung: ['Black', 'Bold', 'ExtraBold', 'ExtraLight', 'Light', 'Medium', 'Regular', 'SemiBold', 'Thin'],
    },
    fontSize: {
  ...
  variants: {
    ...
    textColor: ['responsive', 'dark', 'group-hover', 'focus-within', 'focus-visible', 'hover', 'focus', 'active'],
