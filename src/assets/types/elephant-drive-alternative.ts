export interface ElephantDriveAlternativePageText {
  HeroSection: HeroSection;
  HeaderSection: HeaderSection;
  VersusSection: VersusSection;
  CtaSection: CtaSection;
  CtaSection2: CtaSection;
  tableSection: ElephantDriveAlternativePageTextTableSection;
...
export interface ElephantDriveAlternativePageTextTableSection {
  title: string;
  hotLabel: string;
