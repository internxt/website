export interface OnedriveAlternativePageText {
  HeroSection: Section;
  ...
  CtaSection: Section;
  tableSection: OnedriveAlternativePageTextTableSection;
...
export interface OnedriveAlternativePageTextTableSection {
  title: string;
  hotLabel: string;
