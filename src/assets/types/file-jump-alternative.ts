export interface FileJumpAlternativePageText {
  HeroSection: HeroSection;
  HeaderSection: HeaderSection;
  VersusSection: VersusSection;
  CtaSection: CtaSection;
  CtaSection2: CtaSection;
  tableSection: FileJumpAlternativePageTextTableSection;
...
export interface FileJumpAlternativePageTextTableSection {
  title: string;
  hotLabel: string;
