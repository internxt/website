...
export const PPCAnnualPage = ({
  couponCodeName, metatagsDescriptions, langJson, lang, footerLang, navbarLang }: AnnualProps): JSX.Element => {
  ...
  const {
    ...
    lifetimeCoupon,
    lifetimeCoupons,
  } = usePricing({ couponCode: couponCodeName, couponCodeForLifetime: couponCodeName });
