...
export interface CloudStorageForDocumentsTemplateProps {
...
export const CloudStorageForDocumentsTemplate = ({
  metatagsDescription,
  navbarText,
  textContent,
  footerText,
  ...
  robots,
}: CloudStorageForDocumentsTemplateProps): JSX.Element => {
  ...
  return (
    <Layout title={metatags?.title ?? ''} description={metatags?.description ?? ''} robots={robots}>
