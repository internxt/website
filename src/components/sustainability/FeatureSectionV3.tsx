  ...
  const cards = [
    {
      ...
      image: '/images/sustainability/internxt_sustainability_power.webp',
    },
    {
      icon: Drop,
      ...
      image: '/images/sustainability/internxt_sustainability_water.webp',
    },
    {
      icon: CloudArrowUp,
      ...
      image: '/images/sustainability/internxt_sustainability_carbon.webp',
    },
    {
      ...
      image: '/images/sustainability/internxt_sustainability_renewables.webp',
    },
  ];

  return (
    <section className="overflow-hidden px-5">
      <div className="flex flex-col items-center justify-center space-y-16 bg-gray-1 py-20">
          ...
          {cards.map((card, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <card.icon size={48} className="text-green-dark md:size-[64px]" />
                  <p className="text-3xl font-semibold sm:text-4xl sm:leading-tight md:text-5xl">{card.title}</p>
                  <span className="flex items-start space-x-2 text-4xl font-semibold text-green-1 md:text-5xl">
                    <p>{card.value}</p>
...
export default FeatureSectionV3;
