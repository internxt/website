  ...
  return (
    <>
      <div className="w-full  lg:px-8 xl:px-28 3xl:px-80">
        <div className="hidden h-[160px] w-full flex-col items-center justify-center gap-3 rounded-16 border border-gray-10 bg-white p-4 lg:flex">
      ...
      <div className="flex h-[166px] flex-col items-center justify-center gap-3 rounded-16 border border-gray-10 bg-white px-1 text-center lg:hidden">
        <div className="flex h-[78px] flex-col items-center justify-center px-1 text-center">
          ...
          <p className="w-[313px] text-sm font-normal text-gray-55">{textContent.description}</p>
        </div>
