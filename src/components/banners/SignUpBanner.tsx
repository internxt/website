...
const SignUpBanner = ({
  ...
  return (
    <section className="flex h-[360px] w-full overflow-hidden rounded-16 bg-gradient-to-br from-blue-20 to-white lg:max-w-[1000px] lg-xl:max-w-[1075px] 2xl:max-w-[1250px]">
