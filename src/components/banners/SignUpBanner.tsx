...
const SignUpBanner = ({
  ...
  return (
    <section className="flex h-full w-full items-center justify-center " style={{ background: bgGradientColor }}>
      <div className="mx-4 flex h-auto w-full flex-col overflow-hidden rounded-16 bg-gradient-to-br from-blue-20 to-white px-4 py-8 md:h-[400px] md:flex-row md:px-0 md:py-0 lg:h-[330px] lg:max-w-[1000px] lg-xl:max-w-[1075px] 2xl:max-w-[1250px]">
        <div className="flex w-full flex-col items-center justify-center md:w-max md:flex-row">
          <div className="flex flex-col items-center justify-center space-y-6 md:ml-11 md:items-start md:space-y-8 lg:w-[600px]">
            <div className="w-full text-left md:w-[700px]">
