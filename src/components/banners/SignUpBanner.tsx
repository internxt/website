...
const SignUpBanner = ({
  ...
  return (
    <section className="flex h-[430px] items-center justify-center lg:w-screen" style={{ background: bgGradientColor }}>
      <div className="flex h-full w-[330px] flex-col overflow-hidden rounded-16 bg-gradient-to-br  from-blue-20 to-white px-4 py-8 md:h-[400px] md:flex-row md:px-0 md:py-0 lg:h-[330px] lg:w-full lg:max-w-[1000px] lg-xl:max-w-[1075px] 2xl:max-w-[1250px]">
