...
const FeaturesBanner = () => {
  ...
  return (
    ...
    >
      <div
        className={
          'fixed left-1/2 top-1/2 flex h-max -translate-x-[50%] -translate-y-[50%] flex-col overflow-hidden rounded-2xl bg-white'
        }
      >
        <button
          id="close-banner"
        ...
        <div className="flex max-w-[800px] flex-col items-center justify-between px-10 py-14 md:flex-row lg:w-screen">
          <div className="flex h-max w-full flex-col items-center justify-center space-y-3 text-center lg:items-start lg:justify-between lg:text-start">
            <div className="flex rounded-lg border-4 border-pink bg-red-dark px-3 py-1.5">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col space-y-6">
                {textContent.featuresBanner.features.map((card) => (
                  <div className="flex flex-row items-start space-x-2" key={card}>
                    <Snowflake size={32} className="shrink-0 text-red" />
        ...
        <p className="w-full bg-primary py-3 text-center text-lg font-medium leading-tight text-white">
          🎄{textContent.featuresBanner.title}
        </p>
      </div>
    </div>
