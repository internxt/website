...
interface ComparisonTablePCloudProps {
  textContent: any;
  logo?: string;
  hideTooltip?: boolean;
...
export const ComparisonTablePCloud = ({ textContent, logo, hideTooltip, competitor }: ComparisonTablePCloudProps) => {
  ...
  const competitors = [
    ...
    },
    {
      ...
      features: {
        ...
        features: textContent.tableSection.pcloudFeatures.features,
        comunityAudits: textContent.tableSection.pcloudFeatures.comunityAudits,
        ...
        postQuantumEncryption: textContent.tableSection.pcloudFeatures.postQuantumEncryption,
      },
    },
  ];
