...
const CampaignCtaSection = ({ textContent }) => {
  ...
  return (
    <div className="flex flex-col overflow-hidden px-5">
      <div className="flex flex-col items-center rounded-[32px] border-4 border-primary/10 bg-white xl:px-0">
        <div className="flex h-full flex-col lg:flex-row">
          <div className="flex h-full flex-col items-center justify-center space-y-6 py-16 text-center xl:w-max xl:items-start xl:pl-16 xl:text-left">
