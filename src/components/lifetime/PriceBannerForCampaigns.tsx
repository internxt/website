...
export const PriceBannerForCampaigns = ({ textContent }) => {
  ...
  return (
    <div className={`${shouldShowBanner ? 'flex' : 'hidden'} flex-col overflow-hidden px-5`}>
      ...
      >
        <div className="flex w-full max-w-[500px] flex-col items-center gap-6 px-3 py-10 text-center lg:items-start lg:p-10 lg:py-16 lg:text-left">
          <div className="flex w-max rounded-2xl bg-white px-4 py-2 ring-4 ring-primary">
            <p className="text-3xl font-bold text-primary md:text-5xl">{textContent.label}</p>
          </div>
        ...
        <div className="hidden w-full max-w-[800px] flex-row justify-end lg:flex">
          <Image
