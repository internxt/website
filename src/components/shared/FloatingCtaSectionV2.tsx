...
const FloatingCtaSectionv2 = ({
  ...
  return (
    <section
      className="flex h-[301px] w-full items-center justify-center px-10 lg:py-9 xl:px-32 3xl:px-80"
      style={{ background: bgGradientColor }}
    >
      <div
        className={`z-10 flex h-auto w-full flex-col items-center justify-evenly gap-2 rounded-20 py-2 ${containerDetails}`}
