...
const ScrollableFeatureSection = ({ textContent, cardInfo }) => {
  ...
  return (
    <section className="overflow-hidden bg-gray-1">
      ...
      <div className="hidden flex-row justify-center pb-20 lg:flex">
          ...
          {cardInfo.map((info, index) => (
            <Fragment key={info.title}>
              <button
                ...
                } cursor-pointer flex-row items-start justify-start border-r-4  p-2 pr-8 text-center`}
                onClick={() => {
                  setCardIndex(index);
                }}
              >
                <info.icon className="mb-6 mr-2 items-end text-4xl text-primary" size={32} />
...
export default ScrollableFeatureSection;
