...
const TitleAndOnePlan = ({ textContent, header, footer, lang }: TitleAndOnePlanProps): JSX.Element => {
  ...
  return (
    <div className="hidden max-w-[544px] flex-col pt-8 lg:flex lg:pt-24 lg:pb-10">
      {header ?? (
      ...
      <div className="flex flex-row justify-center gap-4 pt-4 lg:justify-start ">
        ...
        <div className="hidden w-full max-w-[164px] flex-col items-center rounded-lg bg-surface/7 text-primary shadow-sm lg:flex lg:justify-center">
