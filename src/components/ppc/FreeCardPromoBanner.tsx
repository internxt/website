...
export const FreeCardPromoBannerPPC = () => {
  ...
  const isDialogOpen = dialogIsOpen(GlobalDialog.FreeSpaceCardBannerPPC);

  useEffect(() => {
    setShouldShowBanner(dialogIsOpen(GlobalDialog.FreeSpaceCardBannerPPC));
  }, [isDialogOpen]);

  const onCloseBanner = () => {
    closeDialog(GlobalDialog.FreeSpaceCardBannerPPC);
  };
