...
import { IcedriveAlternativePageText } from '@/assets/types/icedrive-alternative';
...
interface IcedriveComparisonProps {
  lang: GetServerSidePropsContext['locale'];
  metatagsDescriptions: MetatagsDescription[];
  navbarLang: NavigationBarText;
  langJson: IcedriveAlternativePageText;
  footerLang: FooterText;
}
const IcedriveComparison = ({
  metatagsDescriptions,
  langJson,
  lang,
  navbarLang,
  footerLang,
}: IcedriveComparisonProps): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <ComparisonTable textContent={langJson.HeaderSection} competitor="Icedrive" />
