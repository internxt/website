...
const CoinGate = ({ lang, metatagsDescriptions, langJson, footerLang, navbarLang }): JSX.Element => {
      ...
      {openDialog ? (
        ...
        z-20 flex w-max -translate-x-1/2 -translate-y-1/2 transform flex-col rounded-2xl bg-white p-7 text-neutral-900`}
          >
            ...
            <SignUp textContent={langJson.Auth} provider="COINGATE" />
          </div>
        </div>
      ) : null}
