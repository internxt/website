        ...
        <div className="ml-5 mt-10 flex h-full w-full max-w-[350px] flex-col rounded-2xl border border-gray-10 sm:max-w-[320px] md:w-screen">
          ...
          <div className="flex h-full flex-col items-center justify-between gap-8 px-6 py-6 text-center">
            ...
            <button
              ...
              onClick={() => router.push('/de/cloud-object-storage/checkout')}
            >
...
export async function getServerSideProps() {
  const metatagsDescriptions = require(`@/assets/lang/pt-br/metatags-descriptions.json`);
  const textContent = require(`@/assets/lang/pt-br/pccomponentes-products-b2b.json`);
  return {
    props: {
