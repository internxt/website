  ...
  return (
    <>
      ...
      <Script type="application/ld+json" strategy="beforeInteractive">
        {sm_breadcrumb('Degoo alternative', 'degoo-alternative')}
      </Script>
<Layout
    ...
    >
      ...
      <Footer textContent={footerLang} lang={locale} needsH2={false} breadcrumbItems={[{ name: 'Encrypted Cloud Storage', url: '/' }, { name: 'Degoo alternative', url: '/degoo-alternative' }]} />
    </Layout>
  </>);
};
