...
const HomeAssistantPage = ({
  ...
  footerLang,
  navbarLang,
}: HomeAssistantProps): JSX.Element => {
  ...
  return (
    <Layout title={metatags?.title ?? ''} description={metatags?.description ?? ''} segmentName="Home" lang={lang}>
      ...
      <ThreeCardsIconsSection textContent={langJson.ThreeCardsSection} bgColor="white" />
      ...
      <MinimalFooter footerLang={footerLang.FooterSection} lang={locale} bgColor="bg-neutral-17" />
    </Layout>
  );
};
