...
const IntenrxtForStudents = ({ metatagsDescriptions, navbarLang, bannerLang, langJson, footerLang, lang }) => {
  const metatags = metatagsDescriptions.filter((desc) => desc.id === 'internxt-for-students');
  return (
    <Layout
...
export async function getServerSideProps(ctx) {
  ...
  const langJson = require(`../assets/lang/en/internxt-for-students.json`);
...
export default IntenrxtForStudents;
