...
import { KoofrAlternativePageText } from '@/assets/types/koofr-alternative';
...
interface KoofrComparisonProps {
  lang: GetServerSidePropsContext['locale'];
  metatagsDescriptions: MetatagsDescription[];
  navbarLang: NavigationBarText;
  langJson: KoofrAlternativePageText;
  footerLang: FooterText;
}
const KoofrComparison = ({
  metatagsDescriptions,
  langJson,
  lang,
  navbarLang,
  footerLang,
}: KoofrComparisonProps): JSX.Element => {
  ...
  return (
    <Layout title={metatags[0].title} description={metatags[0].description} segmentName="Koofr Comparison" lang={lang}>
      ...
      <ComparisonTable textContent={langJson.HeaderSection} competitor="Koofr" />
