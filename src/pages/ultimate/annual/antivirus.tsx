...
const PRICE_BY_CURRENCY: Record<string, string> = {
  eur: '149',
  usd: '179',
};
...
const AntivirusPage = ({
  ...
  const { currency, currencyValue, lifetimeCoupon } = usePricing({
    couponCodeForLifetime: PromoCodeName.antivirus,
  });

  const ultimatePlan = {
    priceId: 'price_1U6Ev3FAOdcgaBMQHxOAmWPO',
    currency: currency,
    currencyValue: currencyValue,
    interval: Interval.Year,
    storage: '1TB',
    price: PRICE_BY_CURRENCY[currencyValue] ?? PRICE_BY_CURRENCY.eur,
  };
