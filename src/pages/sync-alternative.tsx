  ...
  return (
    <>
      ...
      <Script type="application/ld+json" strategy="beforeInteractive">
        {sm_breadcrumb('Alternative to sync', 'sync-alternative')}
      </Script>
<Layout
    ...
    >
      ...
      <Footer textContent={footerLang} lang={locale} needsH2={false} breadcrumbItems={[{ name: 'Encrypted Cloud Storage', url: '/' }, { name: 'Alternative to sync', url: '/sync-alternative' }]} />
    </Layout>
  </>);
};
...
export async function getServerSideProps(ctx: GetServerSidePropsContext) {
  ...
  const langJson = require(`@/assets/lang/${lang}/sync-alternative.json`);
