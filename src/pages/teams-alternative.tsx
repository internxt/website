  ...
  return (
    <>
      ...
      <Script type="application/ld+json" strategy="beforeInteractive">
        {sm_breadcrumb('Microsoft teams alternative', 'teams-alternative')}
      </Script>
<Layout
      title={metatags[0].title}
      description={metatags[0].description}
      segmentName={'Teams Comparison'}
      lang={lang}
    >
      <Navbar textContent={navbarLang} lang={locale} cta={['priceTable']} fixed />
      <HeroSection textContent={langJson.HeroSection} percentage={percentageDiscount} competitor={'Teams'} />

      <ComparisonTable textContent={langJson.HeaderSection} competitor={'Teams'} needH2 />
      ...
      <Footer textContent={footerLang} lang={locale} needsH2={false} breadcrumbItems={[{ name: 'Encrypted Cloud Storage', url: '/' }, { name: 'Microsoft teams alternative', url: '/teams-alternative' }]} />
    </Layout>
  </>);
};
