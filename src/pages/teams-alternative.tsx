  ...
  return (
    <>
      ...
      >
        ...
        <ComparisonTable textContent={langJson.HeaderSection} competitor={'Teams'} percentage={percentageDiscount} needH2 />
        ...
        <Footer
          ...
          breadcrumbItems={[
            ...
            { name: 'Microsoft teams alternative', url: '/teams-alternative' },
          ]}
        />
      </Layout>
    </>
