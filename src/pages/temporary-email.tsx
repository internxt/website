...
const TempEmail = () => {
  ...
  return (
    <>
      ...
      <div id="sidebar_right" className="left-0 mt-36 hidden w-80 justify-end border 3xl:absolute 3xl:flex"></div>
      <div id="sidebar_left" className="right-0 mt-36 hidden w-80 border 3xl:absolute 3xl:flex"></div>
