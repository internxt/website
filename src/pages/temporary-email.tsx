  ...
  return (
    <>
      ...
      <Layout segmentName="Temporary email" title={metatags[0].title} description={metatags[0].description} lang={lang}>
        ...
        <div id="sidebar_right" className="left-0 mt-36 hidden h-screen w-96 lg:absolute lg:flex"></div>
        <div id="sidebar_left" className="right-0 mt-36 hidden h-full w-96 lg:absolute lg:flex"></div>
