...
const Photos = ({
    ...
    lifetimeCoupon,
    lifetimeCoupons,
  } = usePricing({ couponCode: PromoCodeName.META85, couponCodeForLifetime: PromoCodeName.META85 });
  ...
  const onCheckoutButtonClicked = async (
    ...
    return (
        <Layout title={metatags?.title ?? ''} description={metatags?.description ?? ''}>
            ...
            <HeroSection textContent={textContent.HeroSection} url='#billingButtons'/>
